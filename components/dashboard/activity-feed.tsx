...
const eventConfig = {
  ...
  form_submission_received: { icon: ClipboardList, label: "Response" },
  form_submission_read: { icon: Eye, label: "Response" },
  form_submission_handling_changed: { icon: Workflow, label: "Response" },
