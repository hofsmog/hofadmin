...
export const modules: ModuleDefinition[] = [
  ...
  },
  {
    id: "documents",
    name: "Documents",
    description: "Share organization files and resources with the right people.",
    category: "Workspace",
    status: "enabled",
    icon: "documents",
  ...
  },
  {
    id: "news",
    name: "News",
    description: "Publish simple updates for people in your organization.",
    category: "Workspace",
    status: "enabled",
    icon: "announcements",
  },
  ...
  },
  {
    id: "tasks",
    name: "Tasks",
    description: "Show assigned work and follow-ups in My Pages.",
    category: "Operations",
    status: "enabled",
    icon: "tasks",
  },
  {
    id: "issues",
    name: "Issues",
    description: "Track reported issues and follow-up work.",
    category: "Operations",
    status: "enabled",
    icon: "issues",
